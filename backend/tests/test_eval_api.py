...
def _qa_run(rid: int) -> EvalRun:
    ...
    return EvalRun(
        ...
        aggregate={"n": 10, "means": {"faithfulness": 0.8, "answer_relevance": 0.9,
                                      "citation_accuracy": 0.85, "hallucination": 0.12,
                                      "unverified_rate": 0.2},
        ...
        per_query=[{"id": "qa01", "text": "what is X", "answer": "X is ...",
                     ...
                     "judge_scores": {"faithfulness": 0.9, "answer_relevance": 0.85,
                                      "citation_accuracy": 0.88, "hallucination": 0.1},
